...
pub(super) struct OutlineTransparentPhaseItem {
    pub sort_key: FloatOrd,
    pub entity: (Entity, MainEntity),
    pub pipeline: CachedRenderPipelineId,
    pub draw_function: DrawFunctionId,
...
impl PhaseItem for OutlineTransparentPhaseItem {
    #[inline]
    fn entity(&self) -> Entity {
        self.entity.0
    }
...
impl SortedPhaseItem for OutlineTransparentPhaseItem {
    type SortKey = FloatOrd;
...
impl CachedRenderPipelinePhaseItem for OutlineTransparentPhaseItem {
    #[inline]
    fn cached_pipeline(&self) -> CachedRenderPipelineId {
        self.pipeline
    }
